...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SnackView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9SnackView6SVItem")
@interface SVItem : UIView
...
SWIFT_CLASS("_TtC9SnackView17SVApplicationItem")
@interface SVApplicationItem : SVItem
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder;
...
SWIFT_CLASS("_TtC9SnackView12SVButtonItem")
@interface SVButtonItem : SVItem
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC9SnackView17SVDescriptionItem")
@interface SVDescriptionItem : SVItem
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC9SnackView16SVDetailTextItem")
@interface SVDetailTextItem : SVItem
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC9SnackView12SVLoaderItem")
@interface SVLoaderItem : SVItem
...
SWIFT_CLASS("_TtC9SnackView12SVSwitchItem")
@interface SVSwitchItem : SVItem
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC9SnackView15SVTextFieldItem")
@interface SVTextFieldItem : SVItem
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC9SnackView9SnackView")
@interface SnackView : UIViewController
